    ...
    <section class="contract-wrapper">
        <div class="contract-item contract-item-left">
            <div class="title">
                ...
                <div class="link-box">
                     <nuxt-link :to="{name: 'contract-id', params: {id: contractItem.id}}"><span>合约详情&gt;&gt;</span></nuxt-link>
                </div>
            </div>
            <div class="main-content_box">
                ...
                <div class="main-bottom">
                    <div class="mian-item">
                        <span>功耗</span>
                        <span>{{contractItem.power_fee}}&nbsp;W/份</span>
                    </div>
                    <div class="mian-item">
                        <span>电费</span>
                        <span>{{contractItem.energy}}&nbsp;USD/天</span>
                    </div>
                    <div class="mian-item">
                        <span>服务费</span>
        ...
        <div class="contract-item contract-item-right">
            <div class="main-form_box">
                ...
                <div class="bottom-btn">
                    <no-ssr><button v-waves class="btn" @click="createRMBOrder">人民币购买</button></no-ssr>
                    <no-ssr><button v-waves class="btn" @click="createBTCOrder">BTC购买</button></no-ssr>
                </div>
            </div>
        </div>
    </section>
...
export default {
    ...
    created(){
        this.toBTC = toFixed(this.contractItem.price_rmb / this.exchange, 8)
    },
    filters:{
