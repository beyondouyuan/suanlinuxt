        ...
        <div class="item-input_box">
            ...
            <div class="form-bottom">
                ...
                <div class="item row-btn">
                    <button class="btn" :class="FormData.btnClass" @click="handleClick">{{FormData.btnTxt}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    computed: {
        maxUse: function() {
            if(this.FormData.side == 'bid') {
                ...
                return this.FormData.canUse / this.price
            } else {
                if(this.amount == 0) return 0
                return this.FormData.canUse / this.amount
            }
        },
        total: function() {
