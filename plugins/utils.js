/*
 * @Author: beyondouyuan
 * @Date:   2018-08-12 16:42:22
 * @Last Modified by:   beyondouyuan
 * @Last Modified time: 2018-08-18 13:57:21
 */
...
export function isMobile(userAgent) {
  ...
  const flag = ua.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i) ? true : false
  return flag;
}
