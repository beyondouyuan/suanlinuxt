  ...
  <section class="personal-container">
    ...
    <confirm width="500px" title="信息" :visible.sync="confirmDialog" :close-dialog="true">
      ...
      <div class="self-footer" slot="footer">
        <a href="javascript:;" class="self-btn make-sure" @click="handleConfirm">确定</a>
...
import { requestUserInfo, requestVerifyRealName, requestVerifyEmail, requestModifyEmail } from '~/assets/api'
const subMenu = [{
  title: '个人信息',
  name: 'user-profile'
}, {
