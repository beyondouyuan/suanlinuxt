      ...
      <div class="counter-box">
        <div class="counter-top">
          <div class="input-list">
            ...
            <span class="trans">
                            <img src="~/assets/images/conversion-icon.png" />
                        </span>
            <div class="select-box">
...
import { toFixed } from '~/plugins/utils.js'
import {
  requestDiffculty,
  requestDCIncome,
...
export default {
  ...
  async asyncData({ params, req, res, error }) {
    const { diffculty } = await requestDiffculty({ symbol: 'BTC' })
    ...
    for (var index in data) {
      ...
      list_of_price[id] = data[index].price_btc
    ...
    return {
      diffculty: diffculty,
      defaultContactSelected: contracts[0].text,
      contract_id: contracts[0].key,
  ...
  methods: {
    ...
    handleComputeDcIncome() {
      requestDCIncome({
        ...
        this.result = toFixed(power * res.btc_per_day_unit, 8) + ' ' + this.symbol.toUpperCase() + '/天'
      })
    },
