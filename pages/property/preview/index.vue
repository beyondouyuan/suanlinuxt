        ...
        <section class="serial-box">
          ...
          <div class="table-box">
            <div class="data-picker">
              ...
              <date-picker v-if="showStartDatePicker" :date="date" :min-date="minDate" :max-date="maxTime" @confirm="handleStartPicked" @cancel="handleStartCancel"></date-picker>
          ...
          <div v-show="num_pages > 1" class="pagination-container">
...
import { requestAssets, requestAssetsRecord, requestAward } from "~/assets/api"
import { parseTime } from '~/plugins/utils.js'
const subMenu = [{
  title: '收益查看',
...
export default {
  ...
  async asyncData({ params, req, res, error }) {
    ...
    const record = await requestAssetsRecord({
      page: 1
    })
