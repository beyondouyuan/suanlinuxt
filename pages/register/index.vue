<template>
  <div class="login-container">
    <div class="login-wrapper">
      <div class="top">
        <nuxt-link class="login-link" to="/login">已有账号，立即登录&gt;&gt;</nuxt-link>
      </div>
      <div class="login-main">
        ...
        <div class="login-item login-box">
          <ul class="login-list">
            ...
            <li class="input-box">
              <input type="text" v-model="regParams.username" name="username" placeholder="用户名,包含数字和字母，6-20个字符">
            </li>
            <li class="input-box">
              <input type="password" v-model="regParams.password" name="password" placeholder="密码,包含数字和字母，6-20个字符">
            </li>
            <li class="input-box">
              <input type="password" v-model="confirmPassword" name="password" placeholder="请再次输入密码">
            </li>
          </ul>
